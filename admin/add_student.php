    ...
    if (empty($name) || empty($email) || empty($password) || empty($student_id)) {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                $stmt = $pdo->prepare("INSERT INTO students (user_id, student_id, course, year, gender, address, guardian_name, guardian_phone, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
                $stmt->execute([$user_id, $student_id, $course, $year, $gender, $address, $guardian_name, $guardian_phone, $status]);
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-container { max-width: 800px; margin: 40px auto; background: white; padding: 40px; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.1); }
...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="student_id" required placeholder="STU001">
                </div>
            ...
            <div class="form-group">
                ...
                <select name="status" required>
                    <option value="approved">✅ Approved (Can allocate room)</option>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="guardian_phone" placeholder="Guardian contact">
                </div>
            </div>
        ...
        <a href="students.php" class="btn-back">← Back to Students List</a>
    </div>
</body>
</html>
```
